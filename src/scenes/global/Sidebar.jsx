...
const Sidebar = ({role}) => {
  ...
  return (
    ...
    >
            ...
            {!isCollapsed && (
              ...
              >
                <Typography variant="h3" color={colors.grey[100]}>
                  {students && students.role.toUpperCase()}
                </Typography>
            ...
            <Box mb="25px">
              ...
              <Box textAlign="center">
                <Typography
                  ...
                  sx={{ m: "10px 0 0 0" }}
                >
                  { students && students.fname + students.lname}
                </Typography>
      ...
      : role=='tutor' ? <ProSidebar collapsed={isCollapsed}>
      <Menu iconShape="square">
        {/* LOGO AND MENU ICON */}
        <MenuItem
          onClick={() => setIsCollapsed(!isCollapsed)}
